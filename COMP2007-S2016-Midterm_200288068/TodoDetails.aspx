<%@ Page Title="Todo Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TodoDetails.aspx.cs" Inherits="COMP2007_S2016_Midterm_200288068.TodoDetails" %>
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <asp:CheckBox runat="server" CssClass="form-control" ID="Completed" required="true"></asp:CheckBox>
                </div>
